...
const ExamDialog = ({ open, handleClose, initialData, handleSubmit, setFormData, formData }) => {
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>Messages data</DialogTitle>
  ...
  const [tableData, setTableData] = useState([
    {
      ...
      image: 'https://dev-v1.solvedudar.com/uploads/messages/7b63ec8e31fbd5342a02441e946e01c5.jpg'
    },
    {
      id: 2,
      SclGroup: 'B-Tier2',
          ...
          <CCardHeader style={{ padding: '10px' }}>
            <CRow >
              <CCol>
                ...
                <strong style={{ marginLeft: '18px', fontSize: '25px' }}>Messages</strong> <small style={{ fontSize: '17px' }}>List</small>
              </CCol>
...
export default MessageManagements;
