...
const ExamDialog = ({ open, handleClose, initialData, handleSubmit, setFormData, formData }) => {
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>AllDoubt data</DialogTitle>
  ...
  const [tableData, setTableData] = useState([
    {
      ...
      image: 'https://dev-v1.solvedudar.com/uploads/doubt_question/d1a0e3912cce3dbe9cef4b96fe5dd180.png'
    },
    {
      id: 2,
      SclGroup: 'B-Tier2',
          ...
          <CCardHeader style={{ padding: '10px' }}>
            <CRow >
              <CCol>
                ...
                <strong style={{ marginLeft: '18px', fontSize: '25px' }}>All Doubt</strong> <small style={{ fontSize: '17px' }}>List</small>
              </CCol>
