...
const ExamDialog = ({ open, handleClose, initialData, handleSubmit, setFormData, formData }) => {
  ...
  return (
    <Dialog open={open} onClose={handleClose}>
      <DialogTitle>School Group Doubt data</DialogTitle>
  ...
  const [tableData, setTableData] = useState([
    {
      ...
      image: 'https://dev-v1.solvedudar.com/uploads/doubt_question/767e4539d9800f0c988e92397b71d65f.png'
    },
    {
      id: 2,
      SclGroup: 'B-Tier2',
          ...
          <CCardHeader style={{ padding: '10px' }}>
            <CRow >
              <CCol>
                ...
                <strong style={{ marginLeft: '18px', fontSize: '25px' }}>School Doubt</strong> <small style={{ fontSize: '17px' }}>List</small>
              </CCol>
