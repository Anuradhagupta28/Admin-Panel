...
const Exam = () => {
  ...
  const getData = async (currentPage) => {
    ...
    const url = `https://dev-api.solvedudar.com/api/admin/exam/data?page=${currentPage}`; // Replace with your API endpoint
    setLoading(true);
    try {
      const response = await fetch(url, {
        method: "GET",
  ...
  const searchData = async (searchQuery) => {
    ...
    const url = `https://dev-api.solvedudar.com/api/admin/exam/data?search=${encodeURIComponent(searchQuery)}`;
    setLoading(true);
    try {
      const response = await fetch(url, {
        method: "GET",
  ...
  const handleDeleteRole = async (id) => {
    try {
      const response = await fetch(`https://dev-api.solvedudar.com/api/admin/exam/${id}`, {
        method: 'DELETE',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`,
  ...
  const handleAddRole = async (formData) => {
    ...
    try {
      const response = await fetch('https://dev-api.solvedudar.com/api/admin/exam', {
